package com.eyedentifier.cvp3.tracking;
...
import com.eyedentifier.cvp3.env.Size;
...
public class ObjectTracker {
  ...
  static {
    try {
      System.loadLibrary("tensorflow_eyedentifier");
      libraryFound = true;
      LOGGER.i("Library Found!!!");
    } catch (UnsatisfiedLinkError e) {
      LOGGER.e("libtensorflow_eyedentifier.so not found, tracking unavailable");
    }
  }
