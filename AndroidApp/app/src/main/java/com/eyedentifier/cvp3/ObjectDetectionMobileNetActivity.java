...
public class ObjectDetectionMobileNetActivity extends CameraActivity {
    private static final Logger LOGGER = new Logger();

    private static final int TF_OD_API_INPUT_SIZE = 416;
    private static final String TF_OD_API_MODEL_FILE =
            "file:///android_asset/ssd_mobilenet_voc.pb";
                            ...
                            if (location != null && result.getConfidence() >= MINIMUM_CONFIDENCE_TF_OD_API) {
                                ...
                                if(!tts.isSpeaking()) {
                                    tts.speak(result.getTitle(), TextToSpeech.QUEUE_FLUSH, null,
                                            ObjectDetectionMobileNetActivity.class.getName());
                                }
                            }
                        }
